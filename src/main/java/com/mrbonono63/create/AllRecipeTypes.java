...
import com.mrbonono63.create.content.contraptions.components.crafter.MechanicalCraftingRecipe;
import com.mrbonono63.create.content.contraptions.components.crusher.CrushingRecipe;
import com.mrbonono63.create.content.contraptions.components.fan.SplashingRecipe;
import com.mrbonono63.create.content.contraptions.components.millstone.MillingRecipe;
import com.mrbonono63.create.content.contraptions.components.mixer.CompactingRecipe;
import com.mrbonono63.create.content.contraptions.components.mixer.MixingRecipe;
import com.mrbonono63.create.content.contraptions.components.press.PressingRecipe;
import com.mrbonono63.create.content.contraptions.components.saw.CuttingRecipe;
import com.mrbonono63.create.content.contraptions.fluids.actors.FillingRecipe;
import com.mrbonono63.create.content.contraptions.processing.BasinRecipe;
import com.mrbonono63.create.content.contraptions.processing.EmptyingRecipe;
import com.mrbonono63.create.content.contraptions.processing.ProcessingRecipe;
import com.mrbonono63.create.content.contraptions.processing.ProcessingRecipeBuilder.ProcessingRecipeFactory;
import com.mrbonono63.create.content.contraptions.processing.ProcessingRecipeSerializer;
import com.mrbonono63.create.content.curiosities.tools.SandPaperPolishingRecipe;
import com.mrbonono63.create.content.curiosities.zapper.blockzapper.BlockzapperUpgradeRecipe;
