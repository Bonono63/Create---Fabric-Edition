...
import com.mrbonono63.create.content.contraptions.relays.gauge.GaugeBlock.Type;
...
public class GaugeRenderer extends KineticTileEntityRenderer {
	...
	protected GaugeRenderer(TileEntityRendererDispatcher dispatcher, Type type) {
		super(dispatcher);
		this.type = type;
	}
