...
import com.mrbonono63.create.foundation.tileEntity.behaviour.ValueBox.ItemValueBox;
import com.mrbonono63.create.foundation.tileEntity.behaviour.ValueBoxRenderer;
import com.mrbonono63.create.foundation.tileEntity.behaviour.ValueBoxTransform;
import com.mrbonono63.create.foundation.tileEntity.behaviour.ValueBoxTransform.Sided;
...
public class FilteringRenderer {
	...
	public static void renderOnTileEntity(SmartTileEntity tileEntityIn, float partialTicks, MatrixStack ms,
		...
		if (slotPositioning instanceof Sided) {
			Sided sided = (Sided) slotPositioning;
