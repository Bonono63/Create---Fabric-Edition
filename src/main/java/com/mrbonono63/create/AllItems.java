...
import static com.mrbonono63.create.content.AllSections.CURIOSITIES;
import static com.mrbonono63.create.content.AllSections.KINETICS;
import static com.mrbonono63.create.content.AllSections.LOGISTICS;
import static com.mrbonono63.create.content.AllSections.MATERIALS;
...
import com.mrbonono63.create.content.contraptions.components.structureMovement.mounted.MinecartContraptionItem;
import com.mrbonono63.create.content.contraptions.components.structureMovement.train.MinecartCouplingItem;
import com.mrbonono63.create.content.contraptions.goggles.GogglesItem;
import com.mrbonono63.create.content.contraptions.goggles.GogglesModel;
import com.mrbonono63.create.content.contraptions.processing.burner.BlazeBurnerBlockItem;
import com.mrbonono63.create.content.contraptions.relays.belt.item.BeltConnectorItem;
import com.mrbonono63.create.content.contraptions.relays.gearbox.VerticalGearboxItem;
import com.mrbonono63.create.content.contraptions.wrench.WrenchItem;
import com.mrbonono63.create.content.contraptions.wrench.WrenchModel;
import com.mrbonono63.create.content.curiosities.BuildersTeaItem;
import com.mrbonono63.create.content.curiosities.ChromaticCompoundColor;
import com.mrbonono63.create.content.curiosities.ChromaticCompoundItem;
import com.mrbonono63.create.content.curiosities.CombustibleItem;
import com.mrbonono63.create.content.curiosities.RefinedRadianceItem;
import com.mrbonono63.create.content.curiosities.ShadowSteelItem;
import com.mrbonono63.create.content.curiosities.TreeFertilizerItem;
import com.mrbonono63.create.content.curiosities.symmetry.SymmetryWandItem;
import com.mrbonono63.create.content.curiosities.symmetry.client.SymmetryWandModel;
import com.mrbonono63.create.content.curiosities.tools.DeforesterItem;
import com.mrbonono63.create.content.curiosities.tools.DeforesterModel;
import com.mrbonono63.create.content.curiosities.tools.ExtendoGripItem;
import com.mrbonono63.create.content.curiosities.tools.ExtendoGripModel;
import com.mrbonono63.create.content.curiosities.tools.SandPaperItem;
import com.mrbonono63.create.content.curiosities.tools.SandPaperItemRenderer.SandPaperModel;
import com.mrbonono63.create.content.curiosities.zapper.blockzapper.BlockzapperItem;
import com.mrbonono63.create.content.curiosities.zapper.blockzapper.BlockzapperModel;
import com.mrbonono63.create.content.curiosities.zapper.terrainzapper.WorldshaperItem;
import com.mrbonono63.create.content.curiosities.zapper.terrainzapper.WorldshaperModel;
import com.mrbonono63.create.content.logistics.item.filter.FilterItem;
import com.mrbonono63.create.content.schematics.item.SchematicAndQuillItem;
import com.mrbonono63.create.content.schematics.item.SchematicItem;
import com.mrbonono63.create.foundation.data.AssetLookup;
import com.mrbonono63.create.foundation.data.CreateRegistrate;
import com.mrbonono63.create.foundation.item.HiddenIngredientItem;
import com.mrbonono63.create.foundation.item.TagDependentIngredientItem;
