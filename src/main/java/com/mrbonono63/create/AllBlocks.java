...
import static com.mrbonono63.create.content.AllSections.SCHEMATICS;
import static com.mrbonono63.create.foundation.data.BlockStateGen.axisBlock;
import static com.mrbonono63.create.foundation.data.BlockStateGen.oxidizedBlockstate;
import static com.mrbonono63.create.foundation.data.CreateRegistrate.connectedTextures;
import static com.mrbonono63.create.foundation.data.ModelGen.customItemModel;
import static com.mrbonono63.create.foundation.data.ModelGen.oxidizedItemModel;
...
import com.mrbonono63.create.content.contraptions.base.CasingBlock;
import com.mrbonono63.create.content.contraptions.components.actors.DrillBlock;
import com.mrbonono63.create.content.contraptions.components.actors.DrillMovementBehaviour;
import com.mrbonono63.create.content.contraptions.components.actors.HarvesterBlock;
import com.mrbonono63.create.content.contraptions.components.actors.HarvesterMovementBehaviour;
import com.mrbonono63.create.content.contraptions.components.actors.PloughBlock;
import com.mrbonono63.create.content.contraptions.components.actors.PloughMovementBehaviour;
import com.mrbonono63.create.content.contraptions.components.actors.PortableStorageInterfaceBlock;
import com.mrbonono63.create.content.contraptions.components.actors.PortableStorageInterfaceMovement;
import com.mrbonono63.create.content.contraptions.components.actors.SawMovementBehaviour;
import com.mrbonono63.create.content.contraptions.components.actors.SeatBlock;
import com.mrbonono63.create.content.contraptions.components.actors.SeatMovementBehaviour;
import com.mrbonono63.create.content.contraptions.components.clock.CuckooClockBlock;
import com.mrbonono63.create.content.contraptions.components.crafter.CrafterCTBehaviour;
import com.mrbonono63.create.content.contraptions.components.crafter.MechanicalCrafterBlock;
import com.mrbonono63.create.content.contraptions.components.crank.HandCrankBlock;
import com.mrbonono63.create.content.contraptions.components.crank.ValveHandleBlock;
import com.mrbonono63.create.content.contraptions.components.crusher.CrushingWheelBlock;
import com.mrbonono63.create.content.contraptions.components.crusher.CrushingWheelControllerBlock;
import com.mrbonono63.create.content.contraptions.components.deployer.DeployerBlock;
import com.mrbonono63.create.content.contraptions.components.deployer.DeployerMovementBehaviour;
import com.mrbonono63.create.content.contraptions.components.fan.EncasedFanBlock;
import com.mrbonono63.create.content.contraptions.components.fan.NozzleBlock;
import com.mrbonono63.create.content.contraptions.components.flywheel.FlywheelBlock;
import com.mrbonono63.create.content.contraptions.components.flywheel.FlywheelGenerator;
import com.mrbonono63.create.content.contraptions.components.flywheel.engine.FurnaceEngineBlock;
import com.mrbonono63.create.content.contraptions.components.millstone.MillstoneBlock;
import com.mrbonono63.create.content.contraptions.components.mixer.BasinOperatorBlockItem;
import com.mrbonono63.create.content.contraptions.components.mixer.MechanicalMixerBlock;
import com.mrbonono63.create.content.contraptions.components.motor.CreativeMotorBlock;
import com.mrbonono63.create.content.contraptions.components.motor.CreativeMotorGenerator;
import com.mrbonono63.create.content.contraptions.components.press.MechanicalPressBlock;
import com.mrbonono63.create.content.contraptions.components.saw.SawBlock;
import com.mrbonono63.create.content.contraptions.components.saw.SawGenerator;
...
import com.mrbonono63.create.content.contraptions.components.structureMovement.bearing.StabilizedBearingMovementBehaviour;
import com.mrbonono63.create.content.contraptions.components.structureMovement.bearing.WindmillBearingBlock;
import com.mrbonono63.create.content.contraptions.components.structureMovement.chassis.LinearChassisBlock;
import com.mrbonono63.create.content.contraptions.components.structureMovement.chassis.LinearChassisBlock.ChassisCTBehaviour;
import com.mrbonono63.create.content.contraptions.components.structureMovement.chassis.RadialChassisBlock;
import com.mrbonono63.create.content.contraptions.components.structureMovement.chassis.StickerBlock;
import com.mrbonono63.create.content.contraptions.components.structureMovement.gantry.GantryCarriageBlock;
import com.mrbonono63.create.content.contraptions.components.structureMovement.mounted.CartAssemblerBlock;
import com.mrbonono63.create.content.contraptions.components.structureMovement.mounted.CartAssemblerBlock.MinecartAnchorBlock;
import com.mrbonono63.create.content.contraptions.components.structureMovement.mounted.CartAssemblerBlockItem;
import com.mrbonono63.create.content.contraptions.components.structureMovement.piston.MechanicalPistonBlock;
import com.mrbonono63.create.content.contraptions.components.structureMovement.piston.MechanicalPistonHeadBlock;
...
import com.mrbonono63.create.content.contraptions.components.tracks.ControllerRailBlock;
import com.mrbonono63.create.content.contraptions.components.tracks.ControllerRailGenerator;
import com.mrbonono63.create.content.contraptions.components.tracks.ReinforcedRailBlock;
import com.mrbonono63.create.content.contraptions.components.turntable.TurntableBlock;
import com.mrbonono63.create.content.contraptions.components.waterwheel.WaterWheelBlock;
import com.mrbonono63.create.content.contraptions.fluids.PipeAttachmentModel;
import com.mrbonono63.create.content.contraptions.fluids.PumpBlock;
import com.mrbonono63.create.content.contraptions.fluids.actors.HosePulleyBlock;
import com.mrbonono63.create.content.contraptions.fluids.actors.ItemDrainBlock;
import com.mrbonono63.create.content.contraptions.fluids.actors.SpoutBlock;
import com.mrbonono63.create.content.contraptions.fluids.pipes.BracketBlock;
import com.mrbonono63.create.content.contraptions.fluids.pipes.BracketBlockItem;
import com.mrbonono63.create.content.contraptions.fluids.pipes.BracketGenerator;
import com.mrbonono63.create.content.contraptions.fluids.pipes.EncasedPipeBlock;
import com.mrbonono63.create.content.contraptions.fluids.pipes.FluidPipeBlock;
import com.mrbonono63.create.content.contraptions.fluids.pipes.FluidValveBlock;
import com.mrbonono63.create.content.contraptions.fluids.pipes.GlassFluidPipeBlock;
import com.mrbonono63.create.content.contraptions.fluids.pipes.SmartFluidPipeBlock;
import com.mrbonono63.create.content.contraptions.fluids.pipes.SmartFluidPipeGenerator;
import com.mrbonono63.create.content.contraptions.fluids.tank.FluidTankBlock;
import com.mrbonono63.create.content.contraptions.fluids.tank.FluidTankGenerator;
import com.mrbonono63.create.content.contraptions.fluids.tank.FluidTankItem;
import com.mrbonono63.create.content.contraptions.fluids.tank.FluidTankModel;
import com.mrbonono63.create.content.contraptions.processing.BasinBlock;
import com.mrbonono63.create.content.contraptions.processing.BasinGenerator;
import com.mrbonono63.create.content.contraptions.processing.BasinMovementBehaviour;
import com.mrbonono63.create.content.contraptions.processing.burner.BlazeBurnerBlock;
import com.mrbonono63.create.content.contraptions.processing.burner.BlazeBurnerBlockItem;
import com.mrbonono63.create.content.contraptions.processing.burner.LitBlazeBurnerBlock;
import com.mrbonono63.create.content.contraptions.relays.advanced.GantryShaftBlock;
import com.mrbonono63.create.content.contraptions.relays.advanced.SpeedControllerBlock;
import com.mrbonono63.create.content.contraptions.relays.advanced.sequencer.SequencedGearshiftBlock;
import com.mrbonono63.create.content.contraptions.relays.advanced.sequencer.SequencedGearshiftGenerator;
import com.mrbonono63.create.content.contraptions.relays.belt.BeltBlock;
import com.mrbonono63.create.content.contraptions.relays.belt.BeltGenerator;
import com.mrbonono63.create.content.contraptions.relays.belt.BeltModel;
import com.mrbonono63.create.content.contraptions.relays.elementary.BracketedKineticBlockModel;
import com.mrbonono63.create.content.contraptions.relays.elementary.CogWheelBlock;
import com.mrbonono63.create.content.contraptions.relays.elementary.CogwheelBlockItem;
import com.mrbonono63.create.content.contraptions.relays.elementary.ShaftBlock;
import com.mrbonono63.create.content.contraptions.relays.encased.AdjustablePulleyBlock;
import com.mrbonono63.create.content.contraptions.relays.encased.ClutchBlock;
import com.mrbonono63.create.content.contraptions.relays.encased.EncasedBeltBlock;
import com.mrbonono63.create.content.contraptions.relays.encased.EncasedBeltGenerator;
import com.mrbonono63.create.content.contraptions.relays.encased.EncasedCTBehaviour;
import com.mrbonono63.create.content.contraptions.relays.encased.EncasedShaftBlock;
import com.mrbonono63.create.content.contraptions.relays.encased.GearshiftBlock;
import com.mrbonono63.create.content.contraptions.relays.gauge.GaugeBlock;
import com.mrbonono63.create.content.contraptions.relays.gauge.GaugeGenerator;
import com.mrbonono63.create.content.contraptions.relays.gearbox.GearboxBlock;
import com.mrbonono63.create.content.logistics.block.belts.tunnel.BeltTunnelBlock;
import com.mrbonono63.create.content.logistics.block.belts.tunnel.BrassTunnelBlock;
import com.mrbonono63.create.content.logistics.block.belts.tunnel.BrassTunnelCTBehaviour;
import com.mrbonono63.create.content.logistics.block.chute.ChuteBlock;
import com.mrbonono63.create.content.logistics.block.chute.ChuteGenerator;
import com.mrbonono63.create.content.logistics.block.chute.ChuteItem;
import com.mrbonono63.create.content.logistics.block.chute.SmartChuteBlock;
import com.mrbonono63.create.content.logistics.block.depot.DepotBlock;
import com.mrbonono63.create.content.logistics.block.depot.EjectorBlock;
import com.mrbonono63.create.content.logistics.block.depot.EjectorItem;
import com.mrbonono63.create.content.logistics.block.diodes.AbstractDiodeGenerator;
import com.mrbonono63.create.content.logistics.block.diodes.AdjustableRepeaterBlock;
import com.mrbonono63.create.content.logistics.block.diodes.AdjustableRepeaterGenerator;
import com.mrbonono63.create.content.logistics.block.diodes.PoweredLatchBlock;
import com.mrbonono63.create.content.logistics.block.diodes.PoweredLatchGenerator;
import com.mrbonono63.create.content.logistics.block.diodes.PulseRepeaterBlock;
import com.mrbonono63.create.content.logistics.block.diodes.PulseRepeaterGenerator;
import com.mrbonono63.create.content.logistics.block.diodes.ToggleLatchBlock;
import com.mrbonono63.create.content.logistics.block.diodes.ToggleLatchGenerator;
import com.mrbonono63.create.content.logistics.block.funnel.AndesiteFunnelBlock;
import com.mrbonono63.create.content.logistics.block.funnel.BeltFunnelBlock;
import com.mrbonono63.create.content.logistics.block.funnel.BeltFunnelGenerator;
import com.mrbonono63.create.content.logistics.block.funnel.BrassFunnelBlock;
import com.mrbonono63.create.content.logistics.block.funnel.FunnelGenerator;
import com.mrbonono63.create.content.logistics.block.funnel.FunnelItem;
import com.mrbonono63.create.content.logistics.block.funnel.FunnelMovementBehaviour;
import com.mrbonono63.create.content.logistics.block.inventories.AdjustableCrateBlock;
import com.mrbonono63.create.content.logistics.block.inventories.CreativeCrateBlock;
import com.mrbonono63.create.content.logistics.block.mechanicalArm.ArmBlock;
import com.mrbonono63.create.content.logistics.block.mechanicalArm.ArmItem;
import com.mrbonono63.create.content.logistics.block.redstone.AnalogLeverBlock;
import com.mrbonono63.create.content.logistics.block.redstone.ContactMovementBehaviour;
import com.mrbonono63.create.content.logistics.block.redstone.ContentObserverBlock;
import com.mrbonono63.create.content.logistics.block.redstone.NixieTubeBlock;
import com.mrbonono63.create.content.logistics.block.redstone.NixieTubeGenerator;
import com.mrbonono63.create.content.logistics.block.redstone.RedstoneContactBlock;
import com.mrbonono63.create.content.logistics.block.redstone.RedstoneLinkBlock;
import com.mrbonono63.create.content.logistics.block.redstone.RedstoneLinkGenerator;
import com.mrbonono63.create.content.logistics.block.redstone.StockpileSwitchBlock;
import com.mrbonono63.create.content.schematics.block.SchematicTableBlock;
import com.mrbonono63.create.content.schematics.block.SchematicannonBlock;
import com.mrbonono63.create.foundation.block.ItemUseOverrides;
import com.mrbonono63.create.foundation.config.StressConfigDefaults;
import com.mrbonono63.create.foundation.data.AssetLookup;
import com.mrbonono63.create.foundation.data.BlockStateGen;
import com.mrbonono63.create.foundation.data.BuilderTransformers;
import com.mrbonono63.create.foundation.data.CreateRegistrate;
import com.mrbonono63.create.foundation.data.ModelGen;
import com.mrbonono63.create.foundation.data.SharedProperties;
import com.mrbonono63.create.foundation.item.TooltipHelper;
import com.mrbonono63.create.foundation.utility.DyeHelper;
import com.mrbonono63.create.foundation.worldgen.OxidizingBlock;
