...
import static com.mrbonono63.create.foundation.block.connected.CTSpriteShifter.getCT;
import static com.mrbonono63.create.foundation.block.connected.CTSpriteShifter.CTType.HORIZONTAL;
import static com.mrbonono63.create.foundation.block.connected.CTSpriteShifter.CTType.OMNIDIRECTIONAL;
import static com.mrbonono63.create.foundation.block.connected.CTSpriteShifter.CTType.VERTICAL;

import java.util.IdentityHashMap;
import java.util.Map;

import com.mrbonono63.create.content.palettes.PaletteBlockPatterns;
import com.mrbonono63.create.content.palettes.PaletteBlockPatterns.CTs;
import com.mrbonono63.create.content.palettes.PaletteStoneVariants;
import com.mrbonono63.create.foundation.block.connected.CTSpriteShiftEntry;
import com.mrbonono63.create.foundation.block.connected.CTSpriteShifter.CTType;
...
public class AllSpriteShifts {
	...
	static final Map<PaletteStoneVariants, Map<CTs, CTSpriteShiftEntry>> PALETTE_VARIANT_PATTERNS =
		new IdentityHashMap<>();
	...
	public static CTSpriteShiftEntry getVariantPattern(PaletteStoneVariants variant, CTs texture) {
